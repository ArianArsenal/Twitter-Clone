...
public class TweetComponent extends AnchorPane {
    ...
    public TweetComponent(Tweet tweet) {
        this.tweet = tweet;
        this.userId = new Label("@" + tweet.getUser().getId());
        this.username = new Label(tweet.getUser().getName());
        this.tweetBody = new JFXTextArea(tweet.getText());
        this.tweetImage = new ImageView(tweet.getImage());
        this.date = new Label("2023-03-03");
        this.likeAmount = new Label("0");
        this.likes = new Label("Likes");
        this.reTweetAmount = new Label("12");
        this.retweets = new Label(" Retweets");
        this.quotes = new Label("Quotes");
        this.quoteCNT = new Label("55");
        ...
        this.getChildren().addAll(username, userId, pfpC, tweetBody, tweetImage, date, likeAmount, likes, reTweetAmount
                , retweets, quotes, quoteCNT, likeButton, retweetButton, quoteButton, replyButton, twitterForWindows);
        setConfig();
        setLoc();
        //setAction();
    ...
    private void setConfig() {
        ...
        pfpC.setFill(new ImagePattern(tweet.getUser().getProfileImage()));
