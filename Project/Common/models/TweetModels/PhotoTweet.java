...
public class PhotoTweet extends Tweet{
    ...
    public PhotoTweet(String text,String username , ArrayList<Photo> photopost) {
        super(text, username);
    ...
    //TODO
    public PhotoTweet(String text,int likeCount,int retweetCount,int replyCount,int tweetid,boolean isFavStar,String username,ArrayList<Photo> photos){
